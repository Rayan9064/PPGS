  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Nutripal</h1>
      ...
      <div className="grid gap-4 mb-8">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Get immediate nutrition facts and grading</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Alerts for high sugar, fat, or salt content</p>
          </div>
        </div>
      </div>
      ...
      {/* Grading System */}
      <div className="card">
        <h3 className="font-semibold text-gray-900 mb-4">Nutrition Grading System</h3>
