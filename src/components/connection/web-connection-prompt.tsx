        ...
        <div className="bg-gradient-to-r from-red-500 to-red-600 p-6 text-white">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-red-100 text-sm">Your personal nutrition scanner</p>
            </div>
          </div>
        </div>
          ...
          {!connectionStatus.isConnected ? (
            ...
            <div className="text-center">
              ...
              <div className="bg-red-50 dark:bg-red-900/30 rounded-xl p-4 mb-6">
                <h4 className="font-medium text-red-900 dark:text-red-100 mb-2">Features:</h4>
                <ul className="text-sm text-red-800 dark:text-red-200 space-y-1 text-left">
